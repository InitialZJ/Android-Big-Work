...
public class AllListsActivity_zhichu extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout llShouru;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_lists_zhichu);
        context = this;
        ...
        helper.queryList("zhichu", dateBeign, dateEnd);
