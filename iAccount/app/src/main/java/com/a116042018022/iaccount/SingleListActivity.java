...
public class SingleListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper.querySingleList(sp.getString("table", null), sp.getString("kind", null), dateBeign, dateEnd);
