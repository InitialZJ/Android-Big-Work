...
public class RecordActivity extends AppCompatActivity implements View.OnClickListener, DatePicker.OnDateChangedListener, TimePicker.OnTimeChangedListener {
    private Context context;
    private ImageView ivBack;
    private LinearLayout llComplete, llZhichu;
    private EditText shouruNumber, etBeizhu;
    private AppCompatSpinner shouruSpinner;
    ...
    private void initView() {
        ...
        shouruNumber = findViewById(R.id.shouru_number);
        etBeizhu = findViewById(R.id.et_beizhu);
        shouruSpinner = findViewById(R.id.shouru_spinner);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_save:
                ...
                if (!shouruNumber.getEditableText().toString().trim().equals(""))
                {
                    helper.insertData(context, "shouru", shouruSpinner.getSelectedItem().toString(),
                            shouruNumber, ca.getTimeInMillis(), etBeizhu);
                ...
                break;
            case R.id.ll_zhichu:
                startActivityForResult(new Intent(context, RecordActivity_zhichu.class), 1);
                Intent intent = new Intent();
                setResult(1, intent);
                finish();
                break;
